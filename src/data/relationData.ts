...
export const relationsSections: SectionData[] = [
  {
    id: "intro",
    title: "UAE–Sweden Relations (2019–2025)",
    content: [
      {
        type: "paragraph",
        content: "This interactive analysis explores the multifaceted relationship between the United Arab Emirates and Sweden from 2019 to 2025, examining diplomatic ties, economic cooperation, points of alignment and tension, and key stakeholders in both nations."
      },
      {
        type: "paragraph",
