...
const FlagAnimation: React.FC = () => {
  ...
  return (
    <div className="flex items-center space-x-3">
      ...
      >
        <div className="uae-flag h-full w-full relative">
          {/* Vertical red band on the left */}
          <div className="absolute top-0 left-0 h-full w-1/4 bg-[#FF0000]"></div>
          
          {/* Three horizontal stripes on the right */}
          <div className="absolute top-0 left-1/4 w-3/4 h-full">
            <div className="flex h-full flex-col">
              <div className="bg-[#009739] h-1/3 w-full"></div>
              <div className="bg-white h-1/3 w-full"></div>
              <div className="bg-black h-1/3 w-full"></div>
            </div>
          </div>
